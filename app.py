...
# ==========================================
# Step 1: 記事画像の読み込み（縦並びで確実に対応）
# ==========================================
st.header("Step 1. 記事画像のアップロード")
st.info("💡 記事の画像を1枚ずつセットしてください。")

# 確実に表示させるため、縦に並べます
st.markdown("### 1枚目の画像")
img1 = st.file_uploader("記事の1ページ目を選択", type=['png', 'jpg', 'jpeg'], key="img1")

st.markdown("### 2枚目の画像（あれば）")
img2 = st.file_uploader("記事の2ページ目を選択", type=['png', 'jpg', 'jpeg'], key="img2")

st.markdown("### 3枚目の画像（あれば）")
img3 = st.file_uploader("記事の3ページ目を選択", type=['png', 'jpg', 'jpeg'], key="img3")
